			...
			<div id="header">
				...
				<div id="villa-search" class="clearfix">
					...
					<?php echo Form::token(); ?>
						...
						{{ Form::select('bedroom-id', Bedroom::orderby('title')->lists('title','id')->prepend('Please select Bedroom'),null, ['class' => 'form-control']) }}
						</div>
						<div class="col-md-3 col-xs-5">
						{{ Form::select('area-id', Area::lists('title','id')->prepend('Please selct Area'), null, ['class' => 'form-control']) }}
						</div>
