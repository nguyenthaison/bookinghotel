...
<head>
		...
		<link rel="stylesheet" href="{{ URL::asset('assets/css/superfish.css')}}" media="screen">
		...
		<link rel="stylesheet" type="text/css" href="{{ URL::asset('assets/css/frontend.css')}}">
		...
		<script src="{{ URL::asset('assets/js/jquery-migrate-3.0.0.min.js')}}"></script>
		...
		<script src="{{ URL::asset('assets/js/function.min.js')}}"></script>
