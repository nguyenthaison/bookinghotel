...
@section('title', 'Create Special Offers')
    ...
    <div ng-controller="adminController">
    	...
    	<div class="box box-default">
	    	<div class="box-header with-border">
	            <h3 class="box-title">Villa: Create Special Offers</h3>
	        </div>
	        <div class="box-body">
	        ...
	        <div class="box-footer">
	          <button type="submit" ng-click="postVillaOffers(offers)" ng-disabled="SpecialOffersForm.$invalid" class="btn btn-primary">Submit</button>
	        </div>
	    </div>
    </div>
    <!-- /Content -->
