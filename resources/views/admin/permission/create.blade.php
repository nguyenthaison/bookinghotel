...
@section('content')
    ...
    <div class="box box-default">
      ...
      {!! Form::open(['route' => env('ADMIN_URL').'.permission.store', 'method' => 'post', 'name' => 'permissionform']) !!}
      <div class="box-body">
        <div class="col-xs-12 col-md-4">
          <div class="form-group {!! $errors->has('name') ? 'has-error' : '' !!}">
            <label for="key">Title</label>
              <input type="text" class="form-control" name="name" id="name" value="{{ old('name') }}" placeholder="Enter Permission Name">
