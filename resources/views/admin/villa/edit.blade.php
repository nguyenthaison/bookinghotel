...
@section('content')
    <!-- Content -->
    <div class="box box-default" ng-controller="adminController" ng-init="getVillas(<?=$id?>)">
      ...
      <form name="villaform">
        ...
        <div class="panel-body no-gutter">
                ...
                <div class="col-xs-12 col-md-4">
                    ...
                    <div class="form-group">
                      <label for="key">Title</label>
                        <input type="text" class="form-control" ng-model="villas.Title"  ng-required="true" name="title" id="title" placeholder="Enter Villa Name">
                    </div>
                    ...
                    <select class="form-control" name="area" ng-model="villas.Area" ng-required="true">
                        <option ng-repeat="area in areaList | orderBy: 'title'" ng-value="area.id" value="area.id" ng-selected="villas.Area_title == area.title">@{{area.title}}</option>
                  </select>
                </div>
            ...
            <!-- /Content -->
            <!-- Bedroom -->
            <div class="tab-pane fade" id="bedroom" ng-init="getBedrooms()">
              <span>Please select room types</span>
              <div class="row">
                  <ui-select multiple ng-model="villas.multipleBedroom" theme="bootstrap"  close-on-select="false" style="width: 800px;" title="Choose a person">
              ...
              <div class="col-xs-12 col-md-5">
                ...
                <div class="form-group" ng-init="getEnvironments()">
                    ...
                    <select class="form-control" name="role" ng-model="villas.Environment">
                        <option ng-repeat="environment in environmentList | orderBy: 'title'" ng-value="environment.id" value="environment.id" ng-selected="villas.Environment_title == environment.title">@{{environment.title}}</option>
                  </select>
                </div>
      ...
      <!-- /.box-body -->
      <input type="hidden" name="id" ng-model="villas.Id">
      <div class="box-footer">
        <button type="submit" ng-click="editVillas(villas)" ng-disabled="villaform.$invalid" class="btn btn-primary">Submit</button>
      </div>
    </div>
@stop
