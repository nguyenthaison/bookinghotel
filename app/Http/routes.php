...
Route::get('/temporary', 'HomeController@index');
...
Route::post('detail/order', 'VillaController@Order');
...
Route::group(['prefix' => env('ADMIN_URL'), 'middleware' => 'auth'], function () {
	...
	Route::post('delrates', array('as' => env('ADMIN_URL').'.rates.delrates', 
		'uses' => 'Admin\RateController@delrates'));
	// Gallery
